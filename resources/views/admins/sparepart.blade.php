                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float:left">
                            <strong class="card-title">Barang Modal - Spare Part<p class="card-text text-muted" id="spn_totalcount"></p></strong>
...
<script>
    ...
    var kategori    = 'Barang modal - Spare part';
    ...
    function search()
    {
        console.log("CLICK SEARCH Barang modal - Spare part")
        //  variable
