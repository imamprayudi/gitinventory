                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float:left">
                            <strong class="card-title">Barang Contoh - Barang Jadi<p class="card-text text-muted" id="spn_totalcount"></p></strong>
...
<script>
    ...
    function search()
    {
        console.log("CLICK SEARCH Hasil produksi - Contoh")
        //  variable
