...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Trace Data</li><!-- /.menu-title -->
                        <li class="@yield('activetrace')">
                            <a href="{{ url('/trace') }}"><img src="./zlayouts/images/trace.png" height="14px" alt="Trace Data">&emsp;&emsp; Trace Data</a>
                        </li>
                    </li>
    ...
    <!-- Scripts -->
    <script src="./zlayouts/js/jquery.min.js"></script>
