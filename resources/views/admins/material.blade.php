                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float:left">
                            <strong class="card-title">Mutasi Material <p class="card-text text-muted" id="spn_totalcount"></p></strong>
...
function download(){
    ...
    var endate      = $("#endate").val().replace(/-/g, "");
    var partno      = $("#partno").val();
    window.open("material/download?stdate="+stdate+"&endate="+endate+"&partno="+partno+"");
}
