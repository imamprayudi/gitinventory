                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float:left">
                            <strong class="card-title">Scrap<p class="card-text text-muted" id="spn_totalcount"></p></strong>
...
<script>
    ...
    // var kategori    = 'Hasil produksi - Contoh';
    ...
    function search()
    {
        console.log("CLICK SEARCH  Scrap")
        //  variable
        ...
        $.ajax({
            url     : url,
            method  : 'GET',
            data    : {  periode, gudang, kode_barang, nama_barang, satuan, saldo_awal, pemasukan, pengeluaran, penyesuaian, saldo_buku, stock_opame, selisih, keterangan },
            dataType: 'json',
    ...
    function first(jumlahHalaman)
    {
        ...
        $.ajax({
            url     : urlpaging,
            method  : 'GET',
            data    : {  periode, gudang, kode_barang, nama_barang, satuan, saldo_awal, pemasukan, pengeluaran, penyesuaian, saldo_buku, stock_opame, selisih, keterangan, jumlahHalaman },
            dataType: 'json',
            success : function(data)
            {
                var valraquo = data.halamanAktif + 1;
    ...
    function download(){
        ...
        window.open("mutation-download?periode="+periode+"&gudang="+gudang+"&kode_barang="+kode_barang+"&nama_barang="+nama_barang+"&satuan="+satuan+"&saldo_awal="+saldo_awal+"&pemasukan="+pemasukan+"&pengeluaran="+pengeluaran+"&penyesuaian="+penyesuaian+"&saldo_buku="+saldo_buku+"&stock_opame="+stock_opame+"&selisih="+selisih+"&keterangan="+keterangan);
    }
