                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float:left">
                            <strong class="card-title">Barang Modal Mold / Tooling <p class="card-text text-muted" id="spn_totalcount"></p></strong>
...
<script>
    ...
    var kategori      = 'Barang modal - Mould / Cetakan';
