...
class PeralatanPabrikController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admins.peralatan_pabrik', compact('gitversions', 'categories'));
    }
    ...
    public function loaddata(Request $request, $valjmlhal = 1, $jumlahDataPerHalaman = 10)
    {
        ...
        if ($request->ajax()) {
            ...
            $counts = Http::get($this->domain . $this->url . "json_peralatan_pabrik.php", [
                'periode' => $periode,
                'partno' => $partno,
                'tempat' => $this->tempat,
                'page' => 0,
