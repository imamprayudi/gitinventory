...
@section('active_pengemas', 'active')
@section('container')
<!-- Content -->
<div class="content">
    <!-- Animated -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="float:left">
                            <strong class="card-title">Barang Pengemas atau Alat Bantu Pengemas <p class="card-text text-muted" id="spn_totalcount"></p></strong>
...
<script>
    ...
    var kategori      = 'Barang Pengemas atau Alat bantu pengemas';
