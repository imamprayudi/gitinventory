...
class BahanBakuContohController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admins.bahan_baku_contoh', compact('gitversions', 'categories'));
    }

    //  ***
    //  loaddata
    public function loaddata__OLD(Request $request, $valjmlhal = 1, $jumlahDataPerHalaman = 10)
    {
        // return $request;
        // return $valjmlhal;
        // return $request;
        ...
        if ($request->ajax()) {
            ...
            $counts = Http::get($this->domain . "json_bahan_baku.php", [
                'periode' => $periode,
                'partno' => $partno,
                'tempat' => $this->tempat,
                'page' => 0,
    ...
    public function loaddata(Request $request, $valjmlhal = 1, $jumlahDataPerHalaman = 10)
    {
        ...
        if ($request->ajax()) {
            ...
            $counts = Http::get($this->domain . "json_mutation.php", [
                'periode' => $periode,
            ...
            if ($totalcount > 0) {
                ...
                //  mengambil data table
                $sql    = Http::get($this->domain . "json_mutation.php", [
                    'periode' => $periode,
                    'kode_barang' => $kode_barang,
                    'gudang' => $this->gudang,
                    'kategori' => $this->kategori,
